...
## FPGA Button
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { btn_rst }]; #IO_L19N_T3_VREF_16 Sch=btn[0]

## External Buttons
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 PULLDOWN TRUE } [get_ports { btn_1 }];
set_property -dict { PACKAGE_PIN K3   IOSTANDARD LVCMOS33 PULLDOWN TRUE } [get_ports { btn_2 }];
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 PULLDOWN TRUE } [get_ports { btn_3 }];
set_property -dict { PACKAGE_PIN H1   IOSTANDARD LVCMOS33 PULLDOWN TRUE } [get_ports { btn_4 }];
